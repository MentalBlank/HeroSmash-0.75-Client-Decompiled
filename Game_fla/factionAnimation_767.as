...
package Game_fla{
    ...
    public dynamic class factionAnimation_767 extends MovieClip {
        ...
        public function factionAnimation_767(){
        ...
        public function fillDigits(ind:Number){
            ...
            while (i > 0) {
                ...
                this[("f" + i)].fd.tDigit.text = nowDigit;
                sInd++;
                myTime.start();
                i--;
            };
        ...
        function frame5(){
            intPoints = MovieClip(parent.parent).intFaction;
