...
package {
    ...
    public class HouseShop extends MovieClip {
        ...
        public var mcItemList:ItemListHouse;
        ...
        public var mcShopList:ItemListHouse;
        ...
        public function HouseShop(){
            ...
            mcItemList.inventorySlot = rootClass.world.houseitems.length;
            mcItemList.init(rootClass.world.houseitems);
            updateGoldCoin();
            onClickShop(null);
        }
        public function updateGoldCoin():void{
            txtBackPack.text = ((rootClass.world.houseitems.length + "/") + rootClass.world.myAvatar.objData.iHouseSlots);
